...
\section{Argumentative deliberation: Towards formalization using dynamic argumentation logic}\label{sec:ddl}
...
\subsection{Using deliberative model to represent concrete instances of argumentative interaction}\label{sec:examples}
...
\subsection{The search for formal characterization of rational argumentative interaction}\label{sub:for}
