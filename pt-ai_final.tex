...
Given a semantics $\sem$, we now obtain a corresponding argumentative satisfaction relation for $\lang$, defined as follows, for all AFs $E$ and $\phi \in \lang$
$$
E \models_\sem \phi \text{ if } 
