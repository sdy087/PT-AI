...
We have presented a formal approach to the argumentative theory of reason and argued that it should be studied further, also using logical tools. To us, the argumentative theory is particularly interesting because it promises to deliver an alternative approach to reasoning and rationality,  one which sees these notions as irreducibly social and emergent from deliberation. As such it can contribute to the search for new theoretical foundations in a range of different fields, including artificial intelligence, which studies rational and intelligent interaction.

For future work we hope that the simple formal framework developed in this paper can provide a point of departure for the development of more sophisticated technical tools. In the first instance, these should be developed so that they allow clear and informative mathematical modeling of important aspects of argumentative deliberation. Secondly, we also think that they should be developed so that we may take the axiomatic study of deliberative rationality further, allowing formal treatment of the foundational issues themselves, assisted by the use of temporal and fixed-point modal languages interpreted on argumentative structures. On the technical side, we think the interactions between the computational modalities of interaction and the argumentative modalities of meaning, already sketched in Section \ref{sec:for}, is highly interesting and should be considered further.
